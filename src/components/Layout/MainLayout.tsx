...
export const MainLayout = ({ children, centerContent }: any) => {
  return (
    <>
  ...
  document.documentElement.classList.remove('dark')
      ...
      <div className="bg-white dark:bg-gray-900 h-screen">
        ...
        <div className="flex mb-auto relative justify-center justify-items-center h-5/6 overflow-y-visible">
          <aside
            className="w-64 hidden md:block absolute left-0"
            aria-label="Sidebar"
          >
        ...
        <footer className="p-4 bg-white rounded-lg shadow md:px-6 md:py-8 dark:bg-gray-900 fixed bottom-0 w-full">
